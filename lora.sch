...
U 1 1 5FAC327C
P 2900 2625
F 0 "#PWR0102" H 2900 2475 50  0001 C CNN
F 1 "VDD" H 2915 2798 50  0000 C CNN
...
U 1 1 5FAC7E34
P 2900 5425
F 0 "#PWR0108" H 2900 5175 50  0001 C CNN
...
U 1 1 5FACE956
P 1050 4600
F 0 "SW1" H 1050 4985 50  0000 C CNN
F 1 "RESET" H 1050 4894 50  0000 C CNN
F 2 "" H 1050 4900 50  0001 C CNN
F 3 "http://www.apem.com/int/index.php?controller=attachment&id_attachment=1371" H 1050 4900 50  0001 C CNN
	1    1050 4600
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5FAD0EEF
P 1050 3750
F 0 "#PWR0112" H 1050 3500 50  0001 C CNN
...
U 1 1 5FAD9D5E
P 5200 3850
F 0 "J1" H 5200 3650 50  0000 C CNN
F 1 "Conn_01x02" V 5325 3800 50  0000 C CNN
...
U 1 1 5FAF6FCF
P 950 3075
F 0 "J4" H 950 2875 50  0000 C CNN
F 1 "Programming_Jumper" H 950 3175 50  0000 C CNN
...
U 1 1 5FAF81B5
P 1150 3075
F 0 "#PWR0118" H 1150 2825 50  0001 C CNN
F 1 "GND" V 1155 2947 50  0000 R CNN
...
PRG_JP
Text GLabel 3500 4425 2    50   Input ~ 0
GPS_MOSFET_SWITCH
Text GLabel 3500 4325 2    50   Input ~ 0
I2C_SCL
Text GLabel 3500 4225 2    50   Input ~ 0
I2C_SDA
...
SPI_SCK
Text GLabel 3500 4125 2    50   Input ~ 0
SPI_MISO
...
U 1 1 5FAFEC6B
P 6925 2925
F 0 "#PWR0119" H 6925 2675 50  0001 C CNN
F 1 "GND" H 6930 2752 50  0000 C CNN
...
U 1 1 5FB032EE
P 1350 4500
F 0 "R3" V 1250 4525 50  0000 C CNN
F 1 "10k" V 1455 4500 50  0000 C CNN
...
F 1 "VDD" H 1465 4673 50  0000 C CNN
...
U 1 1 5FB04B8A
P 850 4600
F 0 "#PWR0121" H 850 4350 50  0001 C CNN
...
Wire Wire Line
	850  4600 850  4500
Connection ~ 850  4600
Text GLabel 1250 4325 1    50   Input ~ 0
RESET
Wire Wire Line
	1250 4500 1250 4325
Wire Wire Line
...
PRG_RX
Text GLabel 1200 2975 2    50   Input ~ 0
PRG_JP
Text GLabel 3500 3825 2    50   Input ~ 0
UART2_RX
Text GLabel 3500 3925 2    50   Input ~ 0
UART2_TX
...
I2C_SDA
Text GLabel 7050 4475 2    50   Input ~ 0
I2C_SCL
$Comp
L Device:R_Small R16
U 1 1 5FB33DB1
P 7025 4300
F 0 "R16" V 6925 4325 50  0000 C CNN
F 1 "2k2" V 7130 4300 50  0000 C CNN
F 2 "" H 7025 4300 50  0001 C CNN
...
U 1 1 5FB341D1
P 6975 3675
F 0 "R15" V 6875 3700 50  0000 C CNN
F 1 "2k2" V 7080 3675 50  0000 C CNN
...
U 1 1 5FB35895
P 6975 3575
F 0 "#PWR0126" H 6975 3425 50  0001 C CNN
F 1 "VDD" H 6990 3748 50  0000 C CNN
...
F 1 "VDD" H 7040 4373 50  0000 C CNN
...
I2C_SCL
Text GLabel 6925 2825 0    50   Input ~ 0
I2C_SDA
$Comp
...
ONEWIRE2_DATA
Text GLabel 2300 4225 0    50   Input ~ 0
UART1_RX
...
U 1 1 5FAFF168
P 6925 2625
F 0 "#PWR0120" H 6925 2475 50  0001 C CNN
F 1 "VDD" H 6940 2798 50  0000 C CNN
F 2 "" H 6925 2625 50  0001 C CNN
F 3 "" H 6925 2625 50  0001 C CNN
	1    6925 2625
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5FAFE37D
P 7125 2725
F 0 "J9" H 7205 2717 50  0000 L CNN
F 1 "I2C" H 7205 2626 50  0000 L CNN
...
U 1 1 5FB16DFA
P 1250 3550
F 0 "J5" H 1330 3592 50  0000 L CNN
F 1 "Temp" H 1330 3501 50  0000 L CNN
...
U 1 1 5FB18D4E
P 2150 3525
F 0 "C7" H 2058 3479 50  0000 R CNN
F 1 "10u" H 2058 3570 50  0000 R CNN
...
U 1 1 5FB19386
P 2150 3425
F 0 "#PWR0136" H 2150 3275 50  0001 C CNN
F 1 "VDD" H 2165 3598 50  0000 C CNN
F 2 "" H 2150 3425 50  0001 C CNN
...
U 1 1 5FB19D69
P 2150 3625
F 0 "#PWR0137" H 2150 3375 50  0001 C CNN
F 1 "GND" H 2155 3452 50  0000 C CNN
...
Text GLabel 3500 4625 2    50   Input ~ 0
VDD_SENSOR_MOSFET_SWITCH
$Comp
L Device:C_Small C5
U 1 1 5FB2A8D7
P 1250 4700
F 0 "C5" H 1158 4654 50  0000 R CNN
F 1 "100n" H 1158 4745 50  0000 R CNN
...
U 1 1 5FB2B1BB
P 1250 4800
F 0 "#PWR0140" H 1250 4550 50  0001 C CNN
...
U 1 1 5FB29685
P 1775 3500
F 0 "C6" H 1683 3454 50  0000 R CNN
F 1 "100n" H 1683 3545 50  0000 R CNN
...
U 1 1 5FB2B964
P 1775 3400
F 0 "#PWR0144" H 1775 3250 50  0001 C CNN
F 1 "VDD" H 1790 3573 50  0000 C CNN
...
U 1 1 5FB2BF03
P 1775 3600
F 0 "#PWR0145" H 1775 3350 50  0001 C CNN
F 1 "GND" H 1780 3427 50  0000 C CNN
F 2 "" H 1775 3600 50  0001 C CNN
...
U 1 1 5FC04046
P 1150 2875
F 0 "R17" V 1050 2900 50  0000 C CNN
F 1 "10k" V 1255 2875 50  0000 C CNN
...
U 1 1 5FC04CB5
P 1150 2775
F 0 "#PWR01" H 1150 2625 50  0001 C CNN
F 1 "VDD" H 1165 2948 50  0000 C CNN
...
F 1 "ESP32-WROOM-32D" H 2400 2675 50  0000 C CNN
F 2 "RF_Module:ESP32-WROOM-32" H 2900 2525 50  0001 C CNN
F 3 "https://www.espressif.com/sites/default/files/documentation/esp32-wroom-32d_esp32-wroom-32u_datasheet_en.pdf" H 2600 4075 50  0001 C CNN
	1    2900 4025
	1    0    0    -1  
$EndComp
NoConn ~ 2300 4125
...
IO13
Text GLabel 5600 2625 0    50   Input ~ 0
IO13
$Comp
L Connector_Generic:Conn_01x06 J10
U 1 1 5FC2A657
P 5800 2725
F 0 "J10" H 5880 2717 50  0000 L CNN
F 1 "Conn" H 5880 2626 50  0000 L CNN
...
U 1 1 5FC2BE00
P 5600 3025
F 0 "#PWR03" H 5600 2775 50  0001 C CNN
F 1 "GND" H 5605 2852 50  0000 C CNN
...
F 4 "C1647" H 9200 1275 50  0001 C CNN "LCSC"
	...
	0    -1   -1   0   
$EndComp
Text GLabel 3500 4825 2    50   Input ~ 0
32K_XP
Text GLabel 3500 4925 2    50   Input ~ 0
32K_XN
...
IO4
Text GLabel 5600 2525 0    50   Input ~ 0
IO4
Text GLabel 3500 5025 2    50   Input ~ 0
IO34
Text GLabel 5600 2725 0    50   Input ~ 0
IO34
Text GLabel 3500 5125 2    50   Input ~ 0
IO35
Text GLabel 5600 2825 0    50   Input ~ 0
IO35
Wire Notes Line
	4875 475  4875 6050
Text Notes 4975 2350 0    50   ~ 0
Auxilary connectors
$Comp
...
U 1 1 5FB30055
P 5600 3850
F 0 "Q?" V 5942 3850 50  0000 C CNN
F 1 "AO3401A" V 5851 3850 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-23" H 5800 3775 50  0001 L CIN
F 3 "http://www.aosmd.com/pdfs/datasheet/AO3401A.pdf" H 5600 3850 50  0001 L CNN
	1    5600 3850
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5FB309AB
P 5600 4175
F 0 "R?" V 5500 4200 50  0000 C CNN
F 1 "100k" V 5705 4175 50  0000 C CNN
...
U 1 1 5FB31044
P 6000 3850
F 0 "D?" V 6050 3650 50  0000 L CNN
F 1 "MM1Z15" V 6025 3925 50  0000 L CNN
F 2 "" V 6000 3850 50  0001 C CNN
F 3 "~" V 6000 3850 50  0001 C CNN
F 4 " C86235" V 6000 3850 50  0001 C CNN "LCSC"
	1    6000 3850
	0    1    1    0   
$EndComp
Wire Wire Line
...
U 1 1 5FB3880F
P 5600 4275
F 0 "#PWR?" H 5600 4025 50  0001 C CNN
